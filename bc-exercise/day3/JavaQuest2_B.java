...
public class JavaQuest2_B {
  ...
  String str = "I love Java. I love coding"; //if(!(str.length()==27))
  ...
  int year3 = 2400;
  // same as the above, but it will print out.
  isLeapYear = year3 % 4 == 0 && (year3 % 100 > 0 || year3 % 400 == 0);
  if(isLeapYear) {
  ...
  int year5 = 2100;
    ...
    isLeapYear = year5 % 4 == 0 && (year5 % 100 > 0 || year5 % 400 == 0);
  if(isLeapYear) {
